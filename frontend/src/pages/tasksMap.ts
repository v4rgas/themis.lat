export const TASKS_MAP = [
  {
    ...
    severity: "Alto",
    on_fail_message:
      "No se encontraron Bases Administrativas y/o Técnicas diferenciadas.",
    subtasks: [
  ...
  {
    id: 2,
    title: "Revisión especificaciones técnicas",
    code: "H-02",
    ...
    severity: "Muy Alto",
    on_fail_message: "Bases Técnicas no describen adecuadamente el objeto.",
    subtasks: [
  ...
  {
    id: 3,
    title: "Revisión etapas, plazos y criterios",
    code: "H-03",
    ...
    severity: "Alto",
    on_fail_message:
      "Las Bases Administrativas no describen etapas, plazos o criterios.",
    subtasks: [
  ...
  {
    id: 4,
    title: "Revisión de ponderaciones",
    code: "H-07",
    ...
    severity: "Alto",
    on_fail_message: "No hay ponderaciones claras.",
    subtasks: [
  ...
  },
  {
    ...
    severity: "Alto",
    on_fail_message: "Requisitos arbitrarios favorecen a un proveedor.",
    subtasks: [
  ...
  {
    id: 6,
    title: "Revisión control de participación",
    code: "H-13",
    name: "Participación MIPYME no bloqueada",
    desc: "Evaluar si requisitos bloquean a pequeñas empresas.",
    where_to_look: "Bases Adm.",
    severity: "Medio",
    on_fail_message: "Requisitos bloquean participación MIPYME.",
    subtasks: [
  ...
  {
    id: 7,
    title: "Validación de criterio de integridad",
    code: "H-14",
    ...
    severity: "Medio",
    on_fail_message:
      "No existe criterio de integridad en contratación riesgosa.",
    subtasks: ["Verificar si el criterio está presente."],
  },
  {
    id: 8,
    title: "Verificación de publicación contrato",
    code: "H-31",
    ...
    severity: "Medio",
    on_fail_message: "No se publica contrato o su aprobación.",
    subtasks: [
  ...
  {
    id: 9,
    title: "Revisión de criterios excesivos",
    code: "H-08",
    ...
    where_to_look: "Bases Adm.",
    severity: "Bajo",
    on_fail_message: "Criterios vagos generan discrecionalidad.",
    subtasks: [
  ...
  {
    id: 10,
    title: "Confirmación presupuesto declarado",
    code: "H-05",
    name: "Presupuesto estimado declarado",
    desc: "Verificar existencia de presupuesto referencial.",
    where_to_look: "Ficha/Bases",
    severity: "Bajo",
    on_fail_message: "No existe presupuesto estimado.",
    subtasks: ["Comparar montos de ficha y Bases."],
  },
  {
    id: 11,
    title: "Evaluación costo-beneficio",
    code: "H-06",
    name: "Bases orientadas a combinación ventajosa de costo-beneficio",
    desc: "Verificar que no se use solo precio.",
    where_to_look: "Bases Adm.",
    severity: "Medio",
    on_fail_message: "Solo se considera menor precio.",
    subtasks: ["Verificar que ponderaciones no privilegien precio casi 100%."],
  },
];
